...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.ranges = {};
        this.rangesConfig = '111110010000';
        ...
        if (typeof options.startChosenLabel === 'string')
            this.startChosenLabel = options.startChosenLabel;
        
        if (typeof options.startSpanId === 'string')
            this.startSpanId = options.startSpanId;
        ...
        if (typeof options.rangesConfig === 'string')
            this.rangesConfig = options.rangesConfig;
...
//        }
    ...
    DateRangePicker.prototype = {
       ...
       getData: function() {
   			var startDate = this.startDate.format(this.locale.paramFormat);
   			var endDate = this.endDate.format(this.locale.paramFormat);
        ...
        renderCalendar: function(side) {
            ...
            var dateHtml = calendar[1][1].format("YYYY년 ") + this.locale.monthNames[calendar[1][1].month()] + "월";
